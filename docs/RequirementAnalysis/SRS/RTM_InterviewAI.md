...
| Nhóm chức năng | Use Case | User Stories | NFR liên quan | Tài liệu liên quan | Acceptance Criteria chính |
|---|---|---|---|---|---|
...
| Quản trị Question Bank | UC-10 | (Admin UC — chưa có) | M-05, SC-03, SC-05, R-01 | SAD 2.3.1, SAD 2.4.1 | AC-10-1..AC-10-3 |
| Bài test định vị | UC-11 | US-014 | P-04, S-04, Q-01 | SAD 2.2.4 | AC-11-1..AC-11-4 |
| Phỏng vấn ngược | UC-12 | US-015 | P-04, S-04, S-10, S-11, Q-01 | SAD 2.2.3, SAD 2.3.2 | AC-12-1..AC-12-4 |
| Dashboard tiến trình | UC-13 | US-016 | P-01, P-02, R-01, U-03 | SAD 4 | AC-13-1..AC-13-4 |
| An toàn nội dung AI | UC-03, UC-04, UC-05 | US-003..US-010 | AS-01, AS-02, AS-03, AS-04, AS-05, AS-06 | SAD 2.4 | AC-03-2, AC-04-1..AC-04-4, AC-04-9, AC-05-4, AC-05-7 |
| Chất lượng AI output | UC-04, UC-05, UC-06, UC-07 | US-006..US-013 | Q-01, Q-02, Q-03, Q-04, Q-05, Q-06, Q-07 | SAD 2.3, SAD 2.5 | AC-04-3, AC-04-8, AC-05-2, AC-05-6, AC-07-2, AC-07-7, AC-07-8 |
| Hạ tầng bảo mật | (Cross-cutting) | (Cross-cutting) | S-05, S-06 | SAD 2.5 | Network tab audit; tất cả requests dùng HTTPS trên staging/prod |
...
- UC-09 và UC-10 không trace về Discovery insight — xác nhận bởi author (2026-05-09).
- Khi TC được viết, thêm cột `Test Cases` vào §1.
